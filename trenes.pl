foil_predicates([eastbound/1, car/1, shape/1, train/1, short/1, closed/1, long/1, open_car/1, load/3, has_shape/2, wheels/2, has_car/2]).
foil_cwa(true).                   
...
eastbound(west6):-fail.
eastbound(west7):-fail.
eastbound(west8):-fail.
eastbound(west9):-fail.
eastbound(west10):-fail.
...
open_car(car_13).
open_car(car_14).
has_shape(car_11,rectangle). % 4,5
has_shape(car_12,rectangle).
has_shape(car_13,rectangle).
has_shape(car_14,rectangle).
...
short(car_22).
short(car_23).
has_shape(car_21,u_shaped).
has_shape(car_22,u_shaped).
has_shape(car_23,rectangle).
open_car(car_21).
open_car(car_22).
closed(car_23).
...
short(car_32).
long(car_33).
has_shape(car_31,rectangle).
has_shape(car_32,hexagon).
has_shape(car_33,rectangle).
open_car(car_31).
closed(car_32).
closed(car_33).
...
short(car_43).
short(car_44).
has_shape(car_41,u_shaped).
has_shape(car_42,rectangle).
has_shape(car_43,elipse).
has_shape(car_44,rectangle).
double(car_42).
open_car(car_41).
open_car(car_42).
closed(car_43).
...
short(car_52).
short(car_53).
has_shape(car_51,rectangle).
has_shape(car_52,rectangle).
has_shape(car_53,rectangle).
has_double(car_51).
open_car(car_51).
closed(car_52).
closed(car_53).
...
long(car_61).
short(car_62).
has_shape(car_61,rectangle).
has_shape(car_62,rectangle).
closed(car_61).
open_car(car_62).
...
short(car_72).
long(car_73).
has_shape(car_71,rectangle).
has_shape(car_72,u_shaped).
has_shape(car_73,rectangle).
double(car_71).
open_car(car_71).
open_car(car_72).
jagged(car_73).
...
long(car_81).
short(car_82).
has_shape(car_81,rectangle).
has_shape(car_82,u_shaped).
closed(car_81).
open_car(car_82).
...
short(car_93).
short(car_94).
has_shape(car_91,u_shaped).
has_shape(car_92,rectangle).
has_shape(car_93,rectangle).
has_shape(car_94,u_shaped).
open_car(car_91).
jagged(car_92).
open_car(car_93).
open_car(car_94).
...
short(car_101).
long(car_102).
has_shape(car_101,u_shaped).
has_shape(car_102,rectangle).
open_car(car_101).
open_car(car_102).
